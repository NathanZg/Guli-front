    ...
    <div id="aCoursesList" class="bg-fa of">
      ...
      <div>
        <el-pagination
          ...
          @current-change="getTeacherCourseList"
        />
      </div>
    </div>
  </client-only>
...
export default {
  ...
  methods: {
    ...
    getTeacherCourseList(page = 1) {
      this.page = page;
      var that = this;
      teacherApi
        .getTeacherCourseList(this.$route.params.id, this.page, this.limit)
        .then((response) => {
          that.courseList = response.data.data.teacherCourseList;
